...
REM xcopy /C /Q /G /Y /E %USERPROFILE%\Documents\*.txt %dst% >>nul
REM xcopy /C /Q /G /Y /E %USERPROFILE%\Documents\*.docx %dst% >>nul
REM xcopy /C /Q /G /Y /E %USERPROFILE%\Documents\*.csv %dst% >>nul
REM xcopy /C /Q /G /Y /E %USERPROFILE%\Documents\*.xls %dst% >>nul
